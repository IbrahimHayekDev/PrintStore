...
[Table("CustomizableVarints")]
public class CustomizableVarint : Entity
{
	...
	public CustomizableProduct? CustomizableProduct { get; set; }
	public virtual List<ProductMaterial>? ProductMaterials { get; set; }
	public virtual List<AvailableRegion>? AvailableRegions { get; set; }


	public static implicit operator Task<object>(CustomizableVarint v)
	{
